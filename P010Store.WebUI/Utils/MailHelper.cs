...
namespace P010Store.WebUI.Utils
{
    public class MailHelper
    {
        ...
        {
            SmtpClient smtpClient = new SmtpClient("mail.siteadresi.com",587);//1.parametre mailin göndereceği sunucu adresi. 2. parametre mail sunucu part numarası
            smtpClient.Credentials = new NetworkCredential("email kullanıcı adı(info@siteadi.com", "email şifre");
            smtpClient.EnableSsl = true;//eğer mail sunucu ssl sertifikası kullanıyorsa aktif et.
            MailMessage message = new MailMessage();
            message.From = new MailAddress("info@siteadi.com"); //maili gönderen adres
            message.To.Add("mailingönderileceğiadres@gmail.com"); //mailin gönderileceği adres
                                         
            message.To.Add("mailingönderileceğiadres2@gmail.com"); //mailin gönderileceği adres
            ...
            message.IsBodyHtml = true; //html şeklinde kullanmamızı sağladı.
