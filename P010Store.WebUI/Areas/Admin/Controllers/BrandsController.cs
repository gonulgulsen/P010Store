...
namespace P010Store.WebUI.Areas.Admin.Controllers
{
	...
	public class BrandsController : Controller
	{
		...
		private readonly IService<Brand> _service;  //veritabanı işlemleri için generic olarak tasarladığımız repository sınıfını kullanan service interface ini brand class ı için kullanılmak üzere tamamladık.
