...
namespace P010Store.WebAPIUsing.Areas.Admin.Controllers
{
	...
	public class CarouselController : Controller
	{
		...
		private readonly string _apiAdres = "https://localhost:7015/api/Carousel";
		public CarouselController(HttpClient httpClient)
		{
			_httpClient = httpClient;
		}

		// GET: CaruoselController
		...
		// GET: CaruoselController/Details/5
		public ActionResult Details(int id)
		{
			return View();
		}

		// GET: CaruoselController/Create
		public ActionResult Create()
		{
			return View();
		}

		// POST: CaruoselController/Create
		[HttpPost]
		...
		// POST: CaruoselController/Edit/5
		[HttpPost]
		[ValidateAntiForgeryToken]
		...
		// GET: CaruoselController/Delete/5
		...
		// POST: CaruoselController/Delete/5
		[HttpPost]
		[ValidateAntiForgeryToken]
