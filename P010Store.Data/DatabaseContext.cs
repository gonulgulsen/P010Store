...
namespace P010Store.Data
{
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            // optionsBuilder.UseSqlServer(@"Server=mssql.siteadi.com veya 84.118.123.25; database=P010Store; username=veritabanikullaniciadi; password=veritabanisifresi"); // Canlı ayarları için connection string den :

            base.OnConfiguring(optionsBuilder);


			//optionsBuilder.UseInMe
		}
